 ...
 */
public class Railway extends FragmentActivity implements OnMapReadyCallback {
    TextView name;
    TextView place;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            // No google Maps
            Toast.makeText(Railway.this, "Sorry Map Service Unavailable", Toast.LENGTH_SHORT).show();

        }
        name  = (TextView)findViewById(R.id.name);
        name.setText("Surat Railway Station");
        place = (TextView)findViewById(R.id.place_id);
        place.setText("Station Road,Suryapur,Surat,Gujarat 395007");
    ...
    public void GPSIntent(View v)
    {
        ...
        Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                Uri.parse("google.navigation:q=21.2049,72.8408"));
        ...
        fragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
               ...
               /* googleMap.addMarker(new MarkerOptions().position(TIMES_SQUARE)
                ...
                LatLng myMarker = new LatLng(21.2049,72.8408);
                ...
                goToLocationZoom(21.2049,72.8408,15);
